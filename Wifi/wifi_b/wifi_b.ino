/*Viroz D'Souza 400399126
Aaron Sohail 400377526
Marcus J Cameron 400319790 
Quinn Sheppard 400450908 
*/
...
void loop() {
  ...
  client.publish("4ID3_Groupseven/temperature", String(dhtTempEvent.temperature).c_str());
  delay(100);
  client.publish("4ID3_Groupseven/humidity", String(dhtHumEvent.relative_humidity).c_str());
  delay(100);
  client.publish("4ID3_Groupseven/pressure", String(bmpEvent.pressure).c_str());
  delay(100);
  client.publish("4ID3_Groupseven/light", String(lux).c_str());
